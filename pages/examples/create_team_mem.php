<?php
    ...
    if ( !empty($_POST)) {
        ...
        if ($valid) {
            ...
            $sql = "INSERT INTO team_members (team_m_first_name,team_m_last_name,team_m_position,team_m_employement_status,team_id) values(?, ?, ?, ?, ?)";
            $q = $pdo->prepare($sql);
            $q->execute(array($team_m_first_name,$team_m_last_name,$team_m_position,$team_m_employement_status,$team_id));
            Database::disconnect();
		if($val == "company")
		{
...
<body>
    <div class="container">
                ...
                <div class="span10 offset1">
                    <div class="row">
                        <h3>Create a TEAM MEMBERS</h3>
                    </div>
             
                    <form class="form-horizontal" action="create_team_mem.php?val=<?php echo $val?>" method="post">
