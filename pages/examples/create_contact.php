<?php
    ...
    if ( !empty($_POST)) {
        ...
        if ($valid) {
            ...
            $sql = "INSERT INTO contact (contact_name,contact_position,contact_number_one,contact_number_two,contact_email_one,contact_email_two,contact_company_allo) values(?, ?, ?, ?, ?, ?, ?)";
            $q = $pdo->prepare($sql);
                      ...
                      <div class="control-group <?php echo !empty($contact_nameError)?'error':'';?>">
                        ...
                        <div class="controls">
                            ...
                            <?php if (!empty($contact_nameError)): ?>
                                <span class="help-inline"><?php echo $contact_nameError;?></span>
                            <?php endif; ?>
                        </div>
                      </div>
