                ...
                <div class="span10 offset1">
                    ...
                    <div class="form-horizontal" >
                      ...
                      <div class="control-group">
                        ...
                        <div class="controls">
                            <label class="checkbox">
                                <?php echo $data['contact_position'];?>
                            </label>
                        </div>
                      </div>
                      <div class="control-group">
                        ...
                        <div class="controls">
                            <label class="checkbox">
                                <?php echo $data['contact_number_one'];?>
                            </label>
                        </div>
                      </div>
					  <div class="form-horizontal" >
                      <div class="control-group">
                        ...
                        <div class="controls">
                            <label class="checkbox">
                                <?php echo $data['contact_number_two'];?>
                            </label>
                        </div>
                      </div>
                      <div class="control-group">
                        ...
                        <div class="controls">
                            <label class="checkbox">
                                <?php echo $data['contact_email_one'];?>
                            </label>
                        </div>
                      </div>
					  <div class="control-group">
                        ...
                        <div class="controls">
                            <label class="checkbox">
                                <?php echo $data['contact_email_two'];?>
                            </label>
                        </div>
                      </div>
					  <div class="control-group">
                        ...
                        <div class="controls">
                            <label class="checkbox">
                                <?php echo $data['contact_company_allo'];?>
                            </label>
                        </div>
                      </div>
