<?php
    ...
    if ( !empty($_POST)) {
        ...
        if ($valid) {
            ...
            $sql = "INSERT INTO feedback (user_id,ans_1,ans_2,ans_3,ans_4,ans_5,remarks,contact_id) values(?, ?, ?, ?, ?, ?, ?, ?)";
            $q = $pdo->prepare($sql);
            $q->execute(array($user_id,$ans_1,$ans_2,$ans_3,$ans_4,$ans_5,$remarks,$contact_id));
            Database::disconnect();
...
<body>
    <div class="container">
                ...
                <div class="span10 offset1">
                    <div class="row">
                        <h3>Create a Feedback</h3>
                    </div>
             
                    <form class="form-horizontal" action="create_feedback.php" method="post">
					  ...
					  <div class="control-group <?php echo !empty($ans_1Error)?'error':'';?>">
                        ...
                        <div class="controls">
                            <input name="ans_1" type="text"  placeholder="ans_1" value="<?php echo !empty($ans_1)?$ans_1:'';?>">
					  ...
					  <div class="control-group <?php echo !empty($ans_2Error)?'error':'';?>">
                        ...
                        <div class="controls">
                            <input name="ans_2" type="text"  placeholder="ans_2" value="<?php echo !empty($ans_2)?$ans_2:'';?>">
                      ...
                      <div class="control-group <?php echo !empty($ans_3Error)?'error':'';?>">
                        ...
                        <div class="controls">
                            <input name="ans_3" type="text" placeholder="ans_3 Address" value="<?php echo !empty($ans_3)?$ans_3:'';?>">
                      ...
                      <div class="control-group <?php echo !empty($ans_5Error)?'error':'';?>">
                        ...
                        <div class="controls">
                            <input name="ans_5" type="text"  placeholder="ans_5" value="<?php echo !empty($ans_5)?$ans_5:'';?>">
					  ...
					  <div class="control-group <?php echo !empty($remarksError)?'error':'';?>">
                        ...
                        <div class="controls">
                            <input name="remarks" type="text"  placeholder="remarks" value="<?php echo !empty($remarks)?$remarks:'';?>">
					   ...
					   <div class="control-group <?php echo !empty($contact_idError)?'error':'';?>">
                        ...
                        <div class="controls">
                            <input name="contact_id" type="text"  placeholder="contact_id" value="<?php echo !empty($contact_id)?$contact_id:'';?>">
